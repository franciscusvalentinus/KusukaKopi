...
struct BalancePresetView_Previews: PreviewProvider {
    static var previews: some View {
        BalancePresetView(toAdjustVariable: .constant(true), coffeeDose: .constant(""), grindSize: .constant(0), minutes: .constant(0), seconds: .constant(0), brewTemperature: .constant(""), coffeeToWaterRatio: .constant(0), waterTotal: .constant(""), recipeName: .constant(""), beans: .constant(""), variety: .constant(""), region: .constant(""), altitude: .constant(""), showAddRecipe: .constant(true))
    }
}
